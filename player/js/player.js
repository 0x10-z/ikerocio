      ...
      $(".btn-player").on('click',function(e){
        ...
        switch(e.target.id){
          ...
          case "btn-hh-americano-actual":
            play('http://ns4.streaming-live.es:5054/stream', $(this).attr('data-title'));
            break;
          case "btn-hh-americano-clasico":
            play('http://ns4.streaming-live.es:5055/stream', $(this).attr('data-title'));
            break;
          case "btn-hh-espanol-actual":
            play('http://ns4.streaming-live.es:5052/stream', $(this).attr('data-title'));
            break;
          case "btn-hh-espanol-clasico":
            play('http://ns4.streaming-live.es:5053/stream', $(this).attr('data-title'));
            break;
          case "btn-pop-actual":
            play('http://ns4.streaming-live.es:5051/stream', $(this).attr('data-title'));
            break;
          case "btn-rb-actual":
            play('http://ns4.streaming-live.es:5056/stream', $(this).attr('data-title'));
            break;
          case "btn-rb-clasico":
            play('http://ns4.streaming-live.es:5057/stream', $(this).attr('data-title'));
            break;
          case "btn-vinilo":
            play('http://ns4.streaming-live.es:5058/stream', $(this).attr('data-title'));
            break;
        }
        //alert(e.target.id);
      });
